	...
	public void improve(Node child) {
		...
		if(child.getEstimateh()<Double.POSITIVE_INFINITY){
			if(visited==null ){
				...
				if (this.getOpen().size()>memoryBound){
					this.getOpen().remove(this.getOpen().size()-1);
				}
